...
TOOLS = [
    ...
    {"name": "claude_errors", "roles": ["claude"], "description": "Claude Code (or other ingested agent) tool errors — failed tool results (is_error=true) with a body snippet. Not cross-session hotspot patterns — see claude_workflow_insights for that. Default 6h.", "inputSchema": {"type": "object", "properties": dict(_since(), **_agent_prop())}},
